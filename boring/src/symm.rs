...
//!
//! ```
//! use boring_vendit::symm::{encrypt, Cipher};
//!
...
//!
//! ```
//! use boring_vendit::rsa::{Padding, Rsa};
//! use boring_vendit::symm::Cipher;
//!
...
///
/// ```
/// use boring_vendit::symm::{Cipher, Mode, Crypter};
///
...
///
/// ```
/// use boring_vendit::symm::{decrypt, Cipher};
///
/// let cipher = Cipher::aes_128_cbc();
