...
impl X509Builder {
    ...
    ///
    /// ```
    /// use boring_vendit::x509::{X509, X509NameBuilder};
    ///
    /// let mut x509_name = boring_vendit::x509::X509NameBuilder::new().unwrap();
    ...
    ///
    /// let mut x509 = boring_vendit::x509::X509::builder().unwrap();
