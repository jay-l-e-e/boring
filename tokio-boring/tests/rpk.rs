...
mod test_rpk {
    ...
    use boring_vendit::ssl::{SslAcceptor, SslConnector};
    use futures::future;
    ...
    use tokio_boring_vendit::{HandshakeError, SslStream};
    ...
    fn create_server() -> (
        ...
        let server = async move {
            ...
            tokio_boring_vendit::accept(&acceptor, stream).await
        };
    ...
    async fn server_rpk() {
        ...
        let client = async {
            ...
            let mut stream = tokio_boring_vendit::connect(config, "localhost", stream)
                .await
                .unwrap();
    ...
    async fn client_rpk_unknown_cert() {
        ...
        let client = async {
            ...
            let err = tokio_boring_vendit::connect(config, "localhost", stream)
                .await
                .unwrap_err();
